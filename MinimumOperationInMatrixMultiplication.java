...
public class MinimumOperationInMatrixMultiplication {
	
	// calculating the minimum operation for matrix chain multiplication using recursion
	private static int minOperations_1(int a[],int startIndex,int endIndex)
	{
		...
		{
			int output=(minOperations_1(a, startIndex,i)+minOperations_1(a, i, endIndex))+a[startIndex]*a[i]*a[endIndex];
	...
	public static int minOperations_1(int[] a)
	{
		return minOperations_1(a, 0, a.length-1);
	}
	
	// calculating using dynamic programming using recursion
	...
	// iteratively calculating operations in  minimum chain multiplication
	...
	public static void main(String[] args) {
		...
		System.out.println(minOperations_1(a));
